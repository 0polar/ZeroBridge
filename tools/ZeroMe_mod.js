...
(function() {
  ...
  ContentUsers = (function(_super) {
    ...
    function ContentUsers() {
      ...
      this.user_list_active.limit = 180;
      this.user_list_recent = new UserList("recent");
      this.user_list_recent.limit = 600;
      this.loaded = true;
      this.need_update = false;
      this.search = "";
  ...
  Post = (function(superClass) {
    ...
    Post.prototype.renderComments = function() {
      ...
      if (this.row.selected) {
        comment_limit = this.comment_limit + 200;
      } else {
    ...
    Post.prototype.render = function() {
      ...
      return h("div.post", {
        ...
        h("div.user", [
          ...
          classes: {
            maxheight: !this.row.selected && ((ref1 = this.row.body) != null ? ref1.length : void 0) > 12000
          },
